...
- [Script examples](examples.md) - Copy-paste scripts for common reverse-engineering tasks: finding classes, renaming fields, editing method bodies, and making methods no-op.
- [Setup for making plugins & scripts](setup.md) - Resources and information on how to make plugins and scripts
