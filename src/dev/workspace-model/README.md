...
| Method                                                       | Usage                                                        |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| `ResourcePathNode findResource(WorkspaceResource resource)`  | Finds the path to the given `Resource` in the workspace. Mainly useful for getting a `PathNode` to embedded resources without having to do the traversal yourself to construct the path. |
