...
| Opcode                        | Stack: [before]→[after]               | Description                                                                                                                                                |
|-------------------------------|---------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `invokeinterface` <ul><li>owner</li><li>name</li><li>desc</li></ul> | objectref, [arg1, arg2, ...] → result | invokes an interface method defined by the `owner` class and the method's `name` and `desc` on object `objectre`f and puts the result on the stack _(might be `void`)_ |
